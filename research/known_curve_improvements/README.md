...
The separate [toy example](../../examples/toy/) is for functional checks.

Run `ers-research reproduce --study known_curve_improvements --output runs/known-curves` to regenerate all three lower bounds. Stored final witnesses are used only for proof replay. See [the reproducibility guide](../../docs/REPRODUCIBILITY.md).
