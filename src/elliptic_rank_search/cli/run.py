...
from elliptic_rank_search.runtime import ROOT, DATA_ROOTS, code_hashes
HERE=ROOT

from elliptic_rank_search.search.bootstrap import discover, equation, save
...
def data_boundary(source, output):
    ...
    def guard(event,args):
        ...
        if any(path.is_relative_to(root) for root in DATA_ROOTS):
